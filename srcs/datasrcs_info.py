...
srcinfos = {
    ...
    # 'in.gazette.chattisgarh.weekly.<year>-<month>-<day>.<id>' start_date: 2001-07-06 end_date: 2024-08-09 count: 6094
    'cgweekly' : {
        'languages' : ['eng', 'hin'], 
    ...
    'cgextraordinary' : {
        ...
        'prefix'    : 'in.gazette.chattisgarh.eo.'
    },
    ...
    # 'in.gazette.kerala_new.<year>-<month>-<day>.<id>' start_date: 2007-05-22 end_date: 2022-02-33 count: 33070
    'kerala' : {
        'languages' : ['eng', 'mal'],
